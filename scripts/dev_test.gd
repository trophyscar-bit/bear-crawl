...
func _build_levels_grid() -> Vector2:
	var biomes: Array = [
		...
		{"title": "DUNGEON · COBBLE", "floor": "res://assets/texlib/v_cobble_floor.png", "wall": "res://assets/texlib/v_cobble_wall.png", "layout": "dungeon", "tex_note": "Cobble Stone + Stone Wall", "swatch": "res://assets/texlib/v_cobble_floor.png"},
		{"title": "DUNGEON · SKULL", "floor": "res://assets/texlib/v_skull_floor.png", "wall": "res://assets/texlib/v_skull_wall.png", "layout": "dungeon", "tex_note": "Skull Floor + Horror Walls", "swatch": "res://assets/texlib/v_skull_floor.png"},
		{"title": "DUNGEON · SCI-FI", "floor": "res://assets/texlib/v_scifi_floor.png", "wall": "res://assets/texlib/v_scifi_wall.png", "layout": "dungeon", "tex_note": "Sci-Fi + Metal Plates", "swatch": "res://assets/texlib/v_scifi_floor.png"},
		{"title": "DUNGEON · ICE", "floor": "res://assets/texlib/v_ice_floor.png", "wall": "res://assets/texlib/v_ice_wall.png", "layout": "dungeon", "tex_note": "Ice + Stone Wall", "swatch": "res://assets/texlib/v_ice_floor.png"},
		{"title": "DUNGEON · FLESH", "floor": "res://assets/texlib/v_flesh_floor.png", "wall": "res://assets/texlib/v_flesh_wall.png", "layout": "dungeon", "tex_note": "Flesh + Monster Skin", "swatch": "res://assets/texlib/v_flesh_floor.png"},
		{"title": "DUNGEON · PARQUET", "floor": "res://assets/texlib/v_parquet_floor.png", "wall": "res://assets/texlib/v_parquet_wall.png", "layout": "dungeon", "tex_note": "Damaged Parquet + Wall", "swatch": "res://assets/texlib/v_parquet_floor.png"},
		{"title": "DUNGEON · TILES", "floor": "res://assets/texlib/v_tiles_floor.png", "wall": "res://assets/texlib/v_tiles_wall.png", "layout": "dungeon", "tex_note": "Tiles + Indoor Walls", "swatch": "res://assets/texlib/v_tiles_floor.png"},
		{"title": "DUNGEON · MYSTIC", "floor": "res://assets/texlib/v_mystic_floor.png", "wall": "res://assets/texlib/v_mystic_wall.png", "layout": "dungeon", "tex_note": "Mystical + Plant Wall", "swatch": "res://assets/texlib/v_mystic_floor.png"},
		{"title": "DUNGEON · LAVA", "floor": "res://assets/texlib/v_lava_floor.png", "wall": "res://assets/texlib/v_lava_wall.png", "layout": "dungeon", "tex_note": "Lava + Volcano", "swatch": "res://assets/texlib/v_lava_floor.png"},
		{"title": "DUNGEON · GOLD", "floor": "res://assets/texlib/v_gold_floor.png", "wall": "res://assets/texlib/v_gold_wall.png", "layout": "dungeon", "tex_note": "Pile of Gold + Stone Wall", "swatch": "res://assets/texlib/v_gold_floor.png"},
